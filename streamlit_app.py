...
if st.session_state.get("current_page") == "Survey":
    ...
    if "current_prediction" not in st.session_state:
        ...
        with st.form("study_questionnaire"):
            ...
            responses["q_intent_stress_technique"] = likert("I intend to practice at least one stress-management technique (e.g., breathing, journaling, meditation, exercise) in the next 7 days.", "q_intent_stress_technique", likert_scale_7, 4)
